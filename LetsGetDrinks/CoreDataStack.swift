...
class CoreDataStack {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("LetsGetDrinks", withExtension: "momd")!
    ...
    lazy var scratchPSC: NSPersistentStoreCoordinator = {
        // The persistent store coordinator for the application. This implementation creates and returns a coordinator, having added the store for the application to it. This property is optional since there are legitimate error conditions that could cause the creation of the store to fail.
        // Create the coordinator and store
        let coordinator = NSPersistentStoreCoordinator(managedObjectModel: self.managedObjectModel)
        var failureReason = "There was an error creating or loading the application's saved data."
    ...
    // main context for saving favorite venues
    ...
    // scratchContext for loading venues over the network
    lazy var scratchContext: NSManagedObjectContext = {
        let coordinator = self.scratchPSC
    ...
    func saveContext () {
        if managedObjectContext.hasChanges {
            do {
                ...
                NSLog("Unresolved error while saving: \(nserror), \(nserror.userInfo)")
                abort()
            }
        }
    }
